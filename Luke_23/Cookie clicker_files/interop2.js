...
const setCookieCount = (count = 1000000) => {
  const statusEl = document.querySelector('p[role="status"]');
  if (statusEl) statusEl.textContent = `${count} cookies`;
};

window.setCookieCount = setCookieCount;
